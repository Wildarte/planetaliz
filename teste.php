...
?>
    ...
    <main>
        ...
        <section class="sections bg-green sec-news" id="midia">
            <div class="container sec-default">
                <div class="frame home">
                    <div class="head_frame">
                        ...
                        <div class="body_news">
                            ...
                            <div class="body_news_right">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/istoe.png" alt="">
                                <p>Liah Soares faz duo com Ivan Lins em nova animação do Planeta Liz</p>

                                <a href="https://www.portalpopcyber.com/liah-soares-faz-duo-com-ivan-lins-em-nova-animacao-do-planeta-liz/" class="btn_news">Leia completo <i class="bi bi-arrow-right-circle-fill"></i></a>
                                <a href="/na-midia" class="btn_news">Outras notícias <i class="bi bi-arrow-right-circle-fill"></i></a>

                            </div>
                        </div>
                        
                        
                        <div class="car_news owl-carousel">
                            <a href="">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/car.png" alt="">
                                <h3>Notícia</h3>
                            </a>
                            <a href="">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/car.png" alt="">
        ...
        <section class="sections bg-pink sec-default" id="personagens">
            <div class="container">
                <header>
        ...
        <section id="" class="sections sec-default bg-white" role="main" id="blog">
        ...
        <section class=" bg-orange sec-default" id="atividades">
            <div class="container content_sec_ativ">
                ...
                <div class="content_link">
                    <a href=""><img src="<?= get_template_directory_uri() ?>/assets/img/link-ativi1.png" alt=""></a>
                    <a href=""><img src="<?= get_template_directory_uri() ?>/assets/img/link-ativi2.png" alt=""></a>
                </div>
            </div>
        </section>

        <section class="sections sec-contact bg-blue2" id="contato">
